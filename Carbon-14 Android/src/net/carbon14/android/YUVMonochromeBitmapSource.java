...
/**
 * This object implements MonochromeBitmapSource around an array of YUV data,
 * giving you the option to crop to a rectangle within the full data. This can
 * be used to exclude superfluous pixels around the perimeter and speed up
 * decoding.
 * 
 * @author Sean Owen
...
public final class YUVMonochromeBitmapSource extends BaseMonochromeBitmapSource {
	...
	/**
	 * Builds an object around a YUV buffer from the camera. The image is not
	 * cropped.
	 * 
	 * @param yuvData
	 *            A byte array of planar Y data, followed by interleaved U and V
	 * @param dataWidth
	 *            The width of the Y data
	 * @param dataHeight
	...
	/**
	 * Builds an object around a YUV buffer from the camera. THe image is
	 * cropped and only that part of the image is evaluated.
	 * 
	 * @param yuvData
	 *            A byte array of planar Y data, followed by interleaved U and V
	 * @param dataWidth
	 ...
	 *            The height of the Y data
	 * @param cropTop
	 *            Top coordinate of rectangle to crop
	 * @param cropLeft
	 *            Left coordinate of rectangle to crop
	 * @param cropBottom
	 *            Bottom coordinate of rectangle to crop
	 * @param cropRight
	...
	/**
	 * The Y channel is stored as planar data at the head of the array, so we
	 * just ignore the interleavd U and V which follow it.
	 * 
	 * @param x
	 *            The x coordinate to fetch within crop
	 * @param y
	...
	/**
	 * Create a greyscale Android Bitmap from the YUV data based on the crop
	 * rectangle.
	 * 
