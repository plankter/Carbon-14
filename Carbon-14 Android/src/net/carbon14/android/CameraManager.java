...
final class CameraManager {
	 ...
	 * where to place the barcode. The actual captured image should be a bit
	 * larger than indicated because they might frame the shot too tightly. This
	 * target helps with alignment as well as forces the user to hold the device
